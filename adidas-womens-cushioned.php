...
<body>
    ...
    $query = "SELECT * FROM products WHERE gender = 'Female' AND brand = 'Adidas' AND Category = 'Cushioned'";
    ...
    $count_sql = "SELECT COUNT(*) as total FROM products WHERE gender = 'Female' AND brand = 'Adidas'AND Category = 'Cushioned'";
