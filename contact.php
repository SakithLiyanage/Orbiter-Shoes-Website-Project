...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner-content">
                        <h2>CONTACT US</h2>
                        <span>Need assistance? Contact us for prompt and friendly support. Your satisfaction is our top priority.</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container py-5">
        <div class="row py-5">
            <form class="col-md-9 m-auto" method="post" role="form" action="contact.php">
                <div class="row">
...
// Database connection
include 'config.php'; // Adjust this according to your database configuration
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO messages (name, email, subject, msg) VALUES ('$name', '$email', '$subject', '$message')";
