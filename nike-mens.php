...
<body>
    ...
    $query = "SELECT * FROM products WHERE gender = 'Male' AND brand = 'Nike' AND Category = 'Spikes'";
    ...
    $count_sql = "SELECT COUNT(*) as total FROM products WHERE gender = 'Male' AND brand = 'Nike'";
