...
<body>
    ...
    $query = "SELECT * FROM products WHERE gender = 'Female' AND brand = 'Nike' AND Category = 'Spikes'";
    ...
    $count_sql = "SELECT COUNT(*) as total FROM products WHERE gender = 'Female' AND brand = 'Nike'";
