...
<body>
    ...
    $query = "SELECT * FROM products WHERE gender = 'Male' AND brand = 'Puma' AND Category = 'Cushioned'";
    ...
    $count_sql = "SELECT COUNT(*) as total FROM products WHERE gender = 'Male' AND brand = 'Puma' AND Category = 'Cushioned'";
